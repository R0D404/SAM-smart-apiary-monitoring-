    ...
    function fetchDashboardData() {
        ...
        fetch(`/api/dashboard/colmena?id=${colmenaId}`)
            ...
            .catch(err => {
                ...
                const randomPeso = (Math.random() * 10 + 20).toFixed(1);
                renderizarDashboard({
                    codigo: "C-01",
                    ...
                    lecturas: [
                        { peso: randomPeso, temp_interna: 34.5, hum_interna: 60, temp_externa: 28, hum_externa: 55 },
                        { peso: randomPeso - 0.2, temp_interna: 34.4, hum_interna: 59, temp_externa: 27, hum_externa: 50 },
                        { peso: randomPeso - 0.5, temp_interna: 34.2, hum_interna: 61, temp_externa: 26, hum_externa: 52 },
                        { peso: randomPeso - 1.0, temp_interna: 34.0, hum_interna: 62, temp_externa: 25, hum_externa: 55 },
                        { peso: randomPeso - 1.2, temp_interna: 33.8, hum_interna: 60, temp_externa: 24, hum_externa: 58 },
                    ],
                    alertas: [
